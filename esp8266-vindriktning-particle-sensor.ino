...
// use alternative pin for I2C data since D2 is being used to read air sensor
// https://www.aptgetlife.co.uk/alternative-gpio-pins-for-wemos-d1-mini-bme280-sensor/
// U8G2_SSD1306_128X64_NONAME_1_SW_I2C u8g2(U8G2_R0, 5 /* d1 clock */, 12 /* GPIO4->GPIO12 d2->d6 data */);
// U8G2_SSD1306_128X64_NONAME_1_HW_I2C u8g2(U8G2_R0, U8X8_PIN_NONE, 5 /* d1 clock */, 12 /* GPIO4->GPIO6 d2->d6 data */);
...
void loop() {
    ...
    if (currentMillis - statusPublishPreviousMillis >= statusPublishInterval) {
        ...
        if (state.valid) {
          snprintf(avgPM25, sizeof(avgPM25), "%X", state.avgPM25);

            u8g2.clearBuffer();
            u8g2.drawStr(0,20,avgPM25);
            u8g2.sendBuffer();
